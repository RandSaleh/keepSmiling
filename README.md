...
* Add free and com.udacity.gradle.builditbigger.paid flavors to an app, and set up your build to share code between them
...
Add free and com.udacity.gradle.builditbigger.paid product flavors to your app. Remove the ad (and any
dependencies you can) from the com.udacity.gradle.builditbigger.paid flavor.
...
* Project contains com.udacity.gradle.builditbigger.paid/free flavors. The com.udacity.gradle.builditbigger.paid flavor has no ads, and no unnecessary dependencies.
